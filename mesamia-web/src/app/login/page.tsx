    ...
    <div className="min-h-screen bg-brand-ultra-light flex items-center justify-center p-6 text-brand font-sans">
      <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl shadow-brand/10 p-8 md:p-12 border border-slate-50 text-center">
        ...
        <div className="mt-8 pt-8 border-t border-slate-100 space-y-4">
          <button onClick={() => setIsRegister(!isRegister)} className="text-brand-light font-black uppercase tracking-widest text-[10px] hover:text-brand transition-colors">
            {isRegister ? '¿Ya tienes cuenta? Entra aquí' : '¿No tienes cuenta? Regístrate'}
          </button>
          <div>
            <Link href="/" className="inline-flex items-center gap-2 text-slate-300 hover:text-brand text-[10px] font-bold uppercase tracking-widest">
